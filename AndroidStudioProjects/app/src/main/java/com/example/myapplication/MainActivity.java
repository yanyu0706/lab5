...
public class MainActivity extends AppCompatActivity {
    ...
    private void showToast(){
        ...
        View layout=inflater.inflate(R.layout.custom_toast_root,(ViewGroup)findViewById(R.id.custom_toast_root));
    ...
    private void showListDialog(){
        ...
        AlertDialog.Builder dailog_list =new AlertDialog.Builder(MainActivity.this);
        dailog_list.setTitle("使用LIST呈現");
        dailog_list.setItems(list, new DialogInterface.OnClickListener() {
            @Override
